<template>
  <MultiBotChannelEditor
    ...
    :enable-title="t('settings.channels.dingtalk.enabled')"
    :enable-hint="t('settings.channels.dingtalk.enableHint')"
    :disabled-warning="t('settings.channels.dingtalk.disabledWarning')"
    :guide="guide"
    :can-test="canTest"
    ...
    <template #fields="{ model, handleChange, botKey }">
      <div class="config-section">
        ...
        <input
          ...
          type="text"
          :placeholder="t('settings.channels.dingtalk.clientIdPlaceholder')"
          class="config-input"
      ...
      <div class="config-section">
        ...
        <div class="password-input-wrapper">
          <input
            ...
            :placeholder="t('settings.channels.dingtalk.clientSecretPlaceholder')"
            class="config-input"
        ...
        <div class="allow-list">
          <div v-for="(_, index) in model.allow_from" :key="index" class="allow-item">
            <input
              ...
              type="text"
              :placeholder="t('settings.channels.dingtalk.userIdPlaceholder')"
              class="config-input"
              @input="handleChange"
            />
...
const guide = computed(() => ({
  title: t('settings.channels.dingtalk.guideTitle'),
  linkText: t('settings.channels.dingtalk.guideLink'),
  linkHref: 'https://open.dingtalk.com/document/dingstart/build-dingtalk-ai-employees',
  stepText: t('settings.channels.dingtalk.guideStep1'),
  detailText: t('settings.channels.dingtalk.guideStep2')
}))

const canTest = (account: Record<string, any>) => Boolean(account.client_id && account.client_secret)
