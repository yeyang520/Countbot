<template>
  <MultiBotChannelEditor
    ...
    :enable-title="t('settings.channels.feishu.enabled')"
    :enable-hint="t('settings.channels.feishu.enableHint')"
    :disabled-warning="t('settings.channels.feishu.disabledWarning')"
    :guide="guide"
    :can-test="canTest"
    ...
    <template #fields="{ model, handleChange, botKey }">
      <div class="config-section">
        ...
        <input
          ...
          type="text"
          :placeholder="t('settings.channels.feishu.appIdPlaceholder')"
          class="config-input"
      ...
      <div class="config-section">
        ...
        <div class="password-input-wrapper">
          <input
            ...
            :placeholder="t('settings.channels.feishu.appSecretPlaceholder')"
            class="config-input"
        ...
        <div class="allow-list">
          <div v-for="(_, index) in model.allow_from" :key="index" class="allow-item">
            <input
              ...
              type="text"
              :placeholder="t('settings.channels.feishu.userIdPlaceholder')"
              class="config-input"
              @input="handleChange"
            />
...
const guide = computed(() => ({
  title: t('settings.channels.feishu.guideTitle'),
  linkText: t('settings.channels.feishu.guideLink'),
  linkHref: 'https://open.feishu.cn/page/openclaw?user_code=',
  stepText: t('settings.channels.feishu.guideStep1'),
  detailText: t('settings.channels.feishu.guideStep2')
}))
